...
**Sandbox Staring at Flowers** does not implement any custom encryption algorithms or cryptographic functionality. The application only uses standard HTTPS/TLS for secure network communications provided by the operating system.
