...
|------------|----------------|------|-------|
| com.djscottyb.playinginthesandoxlookingatflowers.small | Small Donation | Consumable | $0.99 |
| com.djscottyb.playinginthesandoxlookingatflowers.medium | Medium Donation | Consumable | $1.99 |
...
- ITSAppUsesNonExemptEncryption: false (Already configured in app.json)
...
## Additional Notes
- The privacy policy is hosted on GitHub Pages
